...
function Workgroup() {
    ...
    const [hide, setHide] = useState(
        <div>
            ...
            <Group button={<button onClick={function () { hidden() }} style={{ padding: "15px 25px", fontFamily: "xyz", fontSize: "20px", width: "100%" }} className="btn btn-outline-light">رفتن به این کارگروه</button>} img="/group.png" age="نهم" lesson="ریاضی"></Group>
            <Group button={<button onClick={function () { hidden() }} style={{ padding: "15px 25px", fontFamily: "xyz", fontSize: "20px", width: "100%" }} className="btn btn-outline-light">رفتن به این کارگروه</button>} img="download_1.svg" age="نهم" lesson="زیست"></Group>
        </div>
    )
