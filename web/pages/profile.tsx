            ...
            <div dir="rtl" style={{ padding: "10px 0px" }}>
                <div className="row" dir="ltr" style={{ width: "100%" }}>
                    <div className="col-md-8">
                        <div style={{ borderRadius: "4px", width: "100%", height: "100%", backgroundImage: "url(/download_2.svg)" }}></div>
                    </div>
                    <div className="col-md-4" style={{ paddingRight: "30px" }} dir="rtl">
                        <div style={{ backgroundColor: "white", borderRadius: "4px", padding: "10px", fontFamily: "reg" }}>
                            <div style={{ width: "100%", padding: "20px" }}>
                                <img style={{ borderRadius: "1000px" }} src="/images.jpg" width="100%" height="100%"></img>
                            </div>
                            <br />
