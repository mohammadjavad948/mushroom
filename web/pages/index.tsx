...
function ForDoWork(props) {
  return (
    <div style={{ marginTop: "10px" }}>
      <a href={props.link}>
        <div dir="rtl" style={{ backgroundColor: "white", borderRadius: "4px", padding: "15px 30px 5px 30px", fontFamily: "xyz" }}>
          <div class="row" style={{ width: "100%" }}>
            <div class="col-md-6">
              <div style={{ display: "flex", flexDirection: "row", color: "black", marginBottom: "10px" }}>
                {props.content}
                <span style={{ fontFamily: "reg", color: "grey", marginRight: "20px", fontSize: "14px ", marginTop: "2px" }}>
                  {props.title}
                </span>
              </div>
            </div>
            <div class="col-md-6" style={{ textAlign: "left", fontFamily: "reg", color: "grey", marginBottom: "10px" }}>
  ...
  if (props.children == "no") {
    return (
      <div style={{ marginTop: "130px", textAlign: "center", color: "gray", width: "100%" }}>
        <div style={{ width: "25%", border: "rgb(170 , 170 , 170) solid 2px", margin: "auto", padding: "25px 20px", borderRadius: "4px" }}>
